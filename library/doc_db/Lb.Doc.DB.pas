...
{$IFNDEF SAMPLE}
  // использовать только в разработки, в остальных случаех подключать
  {$R 'db.res'}
{$ENDIF}
...
*******************************************************************************)
  ...
  public
    constructor Create(ADataBase: TDataBase);
    destructor Destroy; override;
    ///<summary>Уникальный ключ, папки</summary>
    property ID: String read FID write FID;
    ///<summary>В какой папки, находится документ</summary>
    property FolderID: String read FFolderID write FFolderID;
    ///<summary>Стутус документа</summary>
...
*******************************************************************************)
  ...
  private
    ...
    function GetDocuments: TDocuments;
  public
    constructor Create(ADataBase: TDataBase);
    destructor Destroy; override;
    ///<summary>Уникальный ключ</summary>
    property ID: String read FID write SetID;
    ///<summary>Объект работы</summary>
    property ParentID: String read FParentID write FParentID;
    ///<summary>Наименование папки</summary>
    ///<remarks>Наименование латинскими буквами</remarks>
    property Name: String read FName write FName;
    ///<summary>Описание объета </summary>
    property Descript: String read FDescript write FDescript;
    ///<summary>Список документов</summary>
    ///<remarks></remarks>
    property Documents: TDocuments read GetDocuments;
  public
...
*******************************************************************************)
  ...
  public
    ...
    destructor Destroy; override;
    procedure Clear;
    ///<summary>Создание списка объекта</summary>
    function GetCreateFolder: TFolder;
    property Items: TFolderList read FItems;
    property ParentFolderID: String read GetParentFolderID write SetParentFolderID;
  public
  ...
  public
    ///<summary>Возвращает ключ, корневой папки</summary>
    function ParentToFolderID: String;
  end;
...
function TFolder.GetDocuments: TDocuments;
begin
  if not SameText(FDocuments.FolderID,FID) then
  begin
...
function TFolders.GetParentFolderID: String;
begin
...
procedure TFolders.SetParentFolderID(const Value: String);
begin
  FParentID := Value;
...
begin
  if SameText(FParentID,'root') then
    ...
    Result := TQueryFolder.PathToFolder(FDataBase.DataModuleDB,Self.ParentFolderID);
end;
...
begin
  if SameText(FParentID,'root') then
    ...
    Result := TQueryFolder.PathToFolderID(FDataBase.DataModuleDB,Self.ParentFolderID);
end;

function TFolders.ParentToFolderID: String;
begin
  Result := '';
  if Assigned(FDataBase) then
    Result := TQueryFolder.ParentToFolderID(FDataBase.DataModuleDB,FParentID);
end;
