...
Type
  ...
  TSWSCErrorEvent = procedure(Sender: TObject; exception:Exception;const Text: string; var forceDisconnect: Boolean) of object;
...
begin
  ...
  try
    ...
    self.Socket.WriteLn('GET ' + uri.path + uri.Document + ' HTTP/1.1');
    self.Socket.WriteLn('Host:' + URI.Host);
    self.Socket.WriteLn('Sec-WebSocket-Version: 13');
    self.Socket.WriteLn('Sec-WebSocket-Key: ' + generateWebSocketKey());
